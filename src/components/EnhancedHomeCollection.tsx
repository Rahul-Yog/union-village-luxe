  ...
  const homeTypes = [
    {
      ...
      features: ["3 Bedrooms", "2.5 Bathrooms", "Finished Basement", "Private Backyards"],
    ...
    },
    {
      ...
      features: ["3 Bedrooms", "2.5 Bathrooms", "Double Car Garage", "Rooftop Terrace"],
      priceRange: "Starting from $1.4M",
    ...
    },
    {
      ...
      features: ["3-4 Bedrooms", "2.5-3.5 Bathrooms", "Double Car Garage", "Private Driveway"],
    ...
    },
    {
      ...
      features: ["4 Bedrooms", "3.5-4.5 Bathrooms", "Double Car Garage", "Larger Lots"],
